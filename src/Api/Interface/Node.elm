...
type alias Fragments decodesTo =
    { onCountryInfo : SelectionSet decodesTo Api.Object.CountryInfo
    , onQuery : SelectionSet decodesTo RootQuery
    , onTransaction : SelectionSet decodesTo Api.Object.Transaction
    , onUser : SelectionSet decodesTo Api.Object.User
    , onWeatherDatum : SelectionSet decodesTo Api.Object.WeatherDatum
    }
...
fragments selections____ =
    Object.exhaustiveFragmentSelection
        [ Object.buildFragment "CountryInfo" selections____.onCountryInfo
        , Object.buildFragment "Query" selections____.onQuery
        , Object.buildFragment "Transaction" selections____.onTransaction
        , Object.buildFragment "User" selections____.onUser
        , Object.buildFragment "WeatherDatum" selections____.onWeatherDatum
        ]
...
maybeFragments =
    { onCountryInfo = Graphql.SelectionSet.empty |> Graphql.SelectionSet.map (\_ -> Nothing)
    ...
    , onWeatherDatum = Graphql.SelectionSet.empty |> Graphql.SelectionSet.map (\_ -> Nothing)
    }
