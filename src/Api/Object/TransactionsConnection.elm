...
module Api.Object.TransactionsConnection exposing (..)
...
nodes :
    ...
    -> SelectionSet (List (Maybe decodesTo)) Api.Object.TransactionsConnection
nodes object____ =
...
edges :
    ...
    -> SelectionSet (List decodesTo) Api.Object.TransactionsConnection
edges object____ =
...
{-| The count of _all_ `Transaction` you could get from the connection.
-}
totalCount : SelectionSet Int Api.Object.TransactionsConnection
totalCount =
