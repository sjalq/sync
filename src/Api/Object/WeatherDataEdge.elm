...
module Api.Object.WeatherDataEdge exposing (..)
...
-}
cursor : SelectionSet (Maybe Api.ScalarCodecs.Cursor) Api.Object.WeatherDataEdge
cursor =
...
{-| The `WeatherDatum` at the end of the edge.
-}
node :
    SelectionSet decodesTo Api.Object.WeatherDatum
    -> SelectionSet (Maybe decodesTo) Api.Object.WeatherDataEdge
node object____ =
